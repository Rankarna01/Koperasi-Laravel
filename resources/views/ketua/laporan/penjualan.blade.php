...
<div class="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 font-heading">Laporan Penjualan</h2>
        <p class="text-slate-500 text-sm mt-1">Laporan rekapitulasi laba dan transaksi dari toko / minimarket koperasi.</p>
    </div>
...
<div class="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm text-center">
    ...
    <p class="text-slate-500 text-sm max-w-md mx-auto">Fitur penarikan data transaksi laba-rugi penjualan untuk Ketua sedang dalam proses pengerjaan. Anda dapat memantau aktivitas keseluruhan melalui Dashboard utama.</p>
</div>
@endsection
